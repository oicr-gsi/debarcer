...
#    
    ...
    Maps = {'network':['UMI_network_degree_{0}.{1}', 'Node degree distribution', 0.7, 'network'],
            'marginal':['UMI_size_depth_marginal_distribution_{0}.{1}', 'Marginal plot', 0.8, 'marginal'],
            'depth':['Read_depth_per_umi_family_{0}.{1}', 'Read depth within group', 0.7, 'read depth']}
