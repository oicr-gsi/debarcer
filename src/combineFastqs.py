...
parser.add_argument('-r1', '--read1',
                    help='Path to first FASTQ file.', required=True)
parser.add_argument('-r2', '--read2',
                    help='Path to second FASTQ file, if necessary.')
parser.add_argument('-r3', '--read3',
                    help='Path to third FASTQ file, if necessary.')
parser.add_argument('-p',  '--prepname',
                    help='Name of library prep to  use (defined in library_prep_types.ini).', required=True)
parser.add_argument('-pf', '--prepfile',
                    help='Path to your library_prep_types.ini file.', required=True)
parser.add_argument('-o',  '--output_path',
                    help='Path to write new files to.', required=True)
