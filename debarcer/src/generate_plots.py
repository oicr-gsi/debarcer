...
def PlotUMiFreqDistr(Datafile, Outputfile):
    '''
    (str, str) -> None
    ...
    # set up y axis label and grid
    ax.set_ylabel('UMI Counts', color = 'black',  size = 14, ha = 'center')
    ax.set_xlabel('Nb of reads', color = 'black',  size = 14, ha = 'center')
