...
\title[Debarcer]{Debarcer: Tools for Debarcoding and Error Correction using SimSeqSeq Molecular Barcoding}
\author[Krzyzanowski \textit{et~al}.]{Paul M. Krzyzanowski\,$^{\text{\sfb 1,}*}$,
Anders Stahlberg\,$^{\text{\sfb 2}}$
Tony Godfrey\,$^{\text{\sfb 2}}$
and Lincoln Stein\,$^{\text{\sfb 2,}*}$}
\address{$^{\text{\sf 1}}$Informatics and Biocomputing, Ontario Institute for Cancer Research, Toronto, Ontario, Canada and \\
...
\textbf{Contact:} \href{Paul Krzyzanowski}{paul.krzyzanowski@oicr.on.ca}\\
